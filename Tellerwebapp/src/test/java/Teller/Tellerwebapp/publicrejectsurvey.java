...
public class publicrejectsurvey {
	...
	public void Tellerlogin2()throws  InterruptedException,NullPointerException{
	   ...
	   // WebElement addquestion=driver.findElement(By.xpath("//label[contains(text(),'Add Questions')]"));
	    ...
	    WebElement survey2=driver.findElement(By.xpath("//mat-card[@id='check-0']//b[contains(text(),'ramyasurveypublicreject')]"));
	    survey2.click();
	    Thread.sleep(5000);
	    ...
	    WebElement selectsurvey=driver.findElement(By.xpath("//mat-card[@id='check-19']//span"));
		...
		public void Tellerlogin31()throws  InterruptedException,NullPointerException {
		   ...
		   // WebElement addquestion=driver.findElement(By.xpath("//label[contains(text(),'Add Questions')]"));
		    ...
		    WebElement survey21=driver.findElement(By.xpath("//mat-card[@id='check-0']//b[contains(text(),'ramyasurveypublicsurvey')]"));
		    survey21.click();
		    Thread.sleep(5000);
