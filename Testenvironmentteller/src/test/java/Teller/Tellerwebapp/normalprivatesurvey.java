...
public class normalprivatesurvey {
	...
	public void Tellerlogin1()throws  InterruptedException,NullPointerException{
		...
		Logger logger=Logger.getLogger("normalprivatesurvey");
		PropertyConfigurator.configure("C://Users//ramya//workspace1//Testenvironmentteller//src//test//java//log4j.properties");
      ...
      loginbutton.click();
	    ...
	    logger.info("Pls enter the survey descripton .");
	    ...
	    logger.info("Pls click the add question .");
	   ...
	   // WebElement addquestion=driver.findElement(By.xpath("//label[contains(text(),'Add Questions')]"));
	    ...
	    logger.info("Pls enter the  question .");
	    ...
	    search.sendKeys("Ramya012");
	    Thread.sleep(5000);
	    
	  
	    
	    WebElement tickres=driver.findElement(By.xpath("//ion-icon[@id='Tickrespondent']"));
	    tickres.click();
	    Thread.sleep(5000);
	  ...
	  //  WebElement more=driver.findElement(By.xpath("//div[@class='flex']//div//ion-icon[@name='more']"));
	    ...
	    WebElement content1=driver.findElement(By.xpath("//strong[contains(text(),'Ramya012 kvn')]"));
